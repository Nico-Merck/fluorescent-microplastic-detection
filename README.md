...
- **Python script**  
  - `spectra_extraction.py`: Script for extracting relevant spectra subsets from the large `data_dict_XX.npy` files and saving them as `spectra_peaks_dict_XX.npy`.  

- **Jupyter Notebook**  
  The main notebook (`spectroscopy_on_fluorescent_mp_particles.ipynb`) covers the full analysis workflow, including data loading, preprocessing, visualization, classification and validation of classification of fluorescence spectra.  
